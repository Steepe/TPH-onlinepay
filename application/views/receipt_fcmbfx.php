...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <div class="col-md-4  " >
            <?php
                if(trim($form_data['vpc_TxnResponseCode']) == "0"){
                ...
                $message .= "Your Transaction Number is ".$form_data['vpc_MerchTxnRef'].".<br>";
                $message .= "Thank you.";
        ...
        <div class="col-md-8  " >
            <div class="table-responsive">
                <h4 class="margin_20"><?php echo $form_data['vpc_Message'] ;?></h4>

                <h5>Transaction Reference: <?php echo $form_data['vpc_MerchTxnRef'];?></h5>
            </div>
        </div>
        <?php
            }
