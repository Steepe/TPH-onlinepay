...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <div class="col-md-4  " >
            <?php
                if(trim($form_data['gtpay_tranx_status_code']) == "00"){
                $amt = $form_data['gtpay_tranx_amt'];

                $message = "Dear giver,<br>";
                $message .= "Your Donation of <strong>".$amt."</strong> to THIS PRESENT HOUSE was successful.<br>";
                $message .= "Your Transaction Number is ".$form_data['gtpay_tranx_id'].".<br>";
                $message .= "Thank you.";
                ...
                $amt = $form_data['gtpay_tranx_amt']/100;

                $message = "Dear giver,<br>";
                $message .= "Your Donation of <strong>".$amt."</strong> to THIS PRESENT HOUSE was not successful at this time.<br> Please try again.";
                $message .= "Your Transaction Number is ".$form_data['gtpay_tranx_id'].".<br>";
                $message .= "Thank you.";
        ...
        <div class="col-md-8  " >
            <div class="table-responsive">
                <h4 class="margin_20"><?php echo $form_data['gtpay_tranx_status_msg'] ;?></h4>

                <h5>Transaction Reference: <?php echo $form_data['gtpay_tranx_id'];?></h5>
            </div>
        </div>
        <?php
            }
